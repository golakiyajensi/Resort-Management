...
$sql="insert into tbleventcategory(CategoryName,Decsription,Price)values(:cname,:catdes,:price)";
...
echo "<script>window.location.href ='add-eventcategory.php'</script>";
  }
  else
    {
