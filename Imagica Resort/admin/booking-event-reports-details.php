...
<html>
<head>
<title>Imagica Resort | Between Dates Booking Reports</title>
...
$sql="SELECT tbluser.*,tbleventbooking.BookingNumber,tbleventbooking.ID,tbleventbooking.Status,tbleventbooking.BookingDate from tbleventbooking join tbluser on tbleventbooking.UserID=tbluser.ID where date(BookingDate) between '$fdate' and '$tdate' LIMIT $offset, $no_of_records_per_page";
