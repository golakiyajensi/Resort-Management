...
<html>
<head>
<title>Imagica Resort | Cancelled Booking</title>
...
<!-- <div class="women_main"> -->
	...
	<div class="grids">
        ...
        $ret = "SELECT ID FROM tbleventbooking";
...
$sql="SELECT tbluser.*,tbleventbooking.BookingNumber,tbleventbooking.Status,tbleventbooking.BookingDate from tbleventbooking join tbluser on tbleventbooking.UserID=tbluser.ID where tbleventbooking.Status='Cancelled' LIMIT $offset, $no_of_records_per_page";
