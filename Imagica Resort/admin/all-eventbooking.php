...
$sql="SELECT tbluser.*,tbleventbooking.BookingNumber,tbleventbooking.ID,tbleventbooking.Status,tbleventbooking.BookingDate from tbleventbooking join tbluser on tbleventbooking.UserID=tbluser.ID  LIMIT $offset, $no_of_records_per_page";
