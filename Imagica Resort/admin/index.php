...
<html>
<head>
<title>Imagica Resort | login page</title>
...
<body>
	<p style="padding-top: 20px;padding-left: 25px; color: red;"><a href="../index.php" style="color: red;"><i class="fa fa-home" aria-hidden="true" style="font-size: 30px;padding-right: 10px;color: red;"></i>Back Home!!!</a></p>
   ...
   <!--/content-inner-->
	...
	<div class="left-content" >
	   <div class="inner-content" >
			...
			<div class="content">
				<!-- <h3 style="color: red;font-family: cursive;">Imagica Resort </h3> -->
<!-- <div class="women_main"> -->
	<!-- start content -->
<div class="registration">
		
	<div class="registration_left">
	<h3 style="color: red;font-family: cursive;text-align:center; font-size:30px;">Imagica Resort Management Sytem</h3>
		<h2 style="text-align:center;">Please sign in</h2>
		 ...
		 <!-- Form -->
			<form method="post">
				...
				<div class="forget">
					<a href="forgot-password.php" style="color: red;font-family: cursive; font-size:15px;">forgot your password</a>
				</div>
			</form>
			<!-- /Form -->
			</div>
