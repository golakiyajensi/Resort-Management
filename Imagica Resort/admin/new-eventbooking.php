...
<html>
<head>
<title>Imagica Resort | New Booking</title>
...
$sql="SELECT tbluser.*,tbleventbooking.BookingNumber,tbleventbooking.Status,tbleventbooking.BookingDate from tbleventbooking join tbluser on tbleventbooking.UserID=tbluser.ID where tbleventbooking.Status is NULL LIMIT $offset, $no_of_records_per_page";
