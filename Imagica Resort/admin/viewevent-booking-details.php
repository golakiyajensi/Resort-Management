...
$sql= "update tbleventbooking set Status=:status,Remark=:remark where BookingNumber=:bookingid";
...
$query->bindParam(':bookingid',$bookingid,PDO::PARAM_STR);
 ...
 echo "<script>window.location.href ='new-eventbooking.php'</script>";
}
?>
<!DOCTYPE HTML>
<html>
<head>
<title>Imagica Resort| View Booking</title>
...
$sql="SELECT tbleventbooking.BookingNumber,tbluser.FullName,tbluser.MobileNumber,tbluser.Email,tbleventbooking.IDType,tbleventbooking.Address,tbleventbooking.CheckinDate,tbleventbooking.CheckoutDate,tbleventbooking.BookingDate,tbleventbooking.Remark,tbleventbooking.Status,tbleventcategory.CategoryName,tbleventcategory.Decsription,tbleventcategory.Price,tblevent.EventName,tblevent.EventDesc,tblevent.Image,tblevent.EventFacility 
...
where tbleventbooking.BookingNumber=:bookid";
$query = $dbh -> prepare($sql);
