...
<html>
<head>
<title>Imagica Resort | Dashboard</title>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: orange"><a href="new-booking.php"><b>New Room Booking</b></a></h4>
...
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: red"><a href="approved-booking.php"><b>Approved Room Booking</b></a></h4>
...
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: magenta"><a href="cancelled-booking.php"><b>Cancelled Room Booking</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                	<?php 
...
?>
				...
				<div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: orange"><a href="new-eventbooking.php"><b>New Event Booking</b></a></h4>
                                <div class="row vertical-center-box 
                                vertical-center-box-tablet">
                                <?php 
                        $sql2 ="SELECT * from  tbleventbooking where Status is null ";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totnewbooking=$query2->rowCount();
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12" style="margin-bottom:1px;">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: red"><a href="approved-eventbooking.php"><b>Approved Event Booking</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                	<?php 
                        $sql2 ="SELECT * from  tbleventbooking where Status='Approved'";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totappbooking=$query2->rowCount();
?>
                        ...
                        <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                            <div class="content-top-1">
                                <h4 class="text-left text-uppercase" style="color: magenta"><a href="cancelled-eventbooking.php"><b>Cancelled Event Booking</b></a></h4>
                                <div class="row vertical-center-box vertical-center-box-tablet">
                                	<?php 
                        $sql2 ="SELECT * from  tbleventbooking where Status='Cancelled'";
$query2 = $dbh -> prepare($sql2);
$query2->execute();
$results2=$query2->fetchAll(PDO::FETCH_OBJ);
$totcanbooking=$query2->rowCount();
